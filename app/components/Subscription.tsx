...
const Subscription: React.FC<SubscriptionProps> = () => {
  return (
    <div>
      <div
        className={clsx(
          'flex w-full flex-col items-stretch rounded-b-xl bg-offWhite px-4 pb-4 pt-24',
        )}
      >
        <TwoColumnLayout
          column1={
            <>
              <div className="mt-20 md:mt-28">
                ...
                <p className=" my-6 text-sm leading-paragraph text-primaryText">
                  ...
                  πραγματικότητα, με αποδεδειγμένα οφέλη σύμφωνα με τις αρχές
                  της Ευρωπαϊκής Αρχής Ασφάλειας Τροφίμων. Η μελετημένη σύσταση
                  και δοσολογία του, καθιστά τη συνεργική αλληλεπίδραση των
                ...
                <div className="my-12 md:grid md:grid-cols-2 md:gap-4">
                  ...
                  <div className="md:border-l-1 lg:border-gray-300 border-t p-6 md:border-l md:border-t-0">
                    ...
                    <p className="my-3 text-[12px] font-bold underline">
                      <a href="/pages/shop">
                        {' '}
                        Δες όλα τα πακέτα χωρίς συνδρομή
                      </a>
                    </p>{' '}
                    <Button
          ...
          column2={{
            ...
            key: 'column2',
            className:
              'h-full w-full object-cover object-center rounded-lg m-0 p-0 ',
          }}
          imageOnLeft={true}
          className="gap-x-16"
        />
